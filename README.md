...
It keeps the current 5-hour and weekly allowances in the macOS menu bar, alongside the other status items. Click the menu-bar item for both usage details.
